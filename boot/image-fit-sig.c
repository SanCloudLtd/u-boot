...
#if defined(CONFIG_SPL_BUILD) && defined(CONFIG_SPL_RSA_VERIFY_WITH_PKEY) &&   \
	defined(CONFIG_SPL_FIT_SIGNATURE)
					   ...
					   const void *key_blob)
{
	...
	defined(CONFIG_SPL_FIT_SIGNATURE)
		...
		return -EPERM;
#endif
#if !defined(CONFIG_SPL_BUILD) && defined(CONFIG_RSA_VERIFY_WITH_PKEY) &&      \
